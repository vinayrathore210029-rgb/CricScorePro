      ...
      <div>
        ...
        <div className="flex rounded-lg overflow-hidden border border-slate-700">
          <input
            ...
            className="flex-1 bg-slate-900 px-4 py-2 text-sm text-white placeholder-slate-500 outline-none"
          />
          <button className="bg-primary-600 px-4 text-sm font-medium text-white hover:bg-primary-700 transition">
            Subscribe
          </button>
        </div>
      </div>
